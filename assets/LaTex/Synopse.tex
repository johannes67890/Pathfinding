...
\begin{figure}[ht]%
  \centering
  \subfloat[\centering Test af A* algoritmen]{{\includegraphics[width=9cm]{../AppPreview.PNG} }}%
  \subfloat[\centering Test af interaktion med gitter]{{\includegraphics[width=9cm]{../AppPreview2.PNG} }}%
  \caption{Test af A* algoritmen}
\end{figure}
\section{Konklusion}
\newpage
\section*{Bilag}
